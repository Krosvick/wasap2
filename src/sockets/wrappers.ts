...
import { ISocketInfo, isValidConversation, leaveRoom, saveMessage } from "../chat_helpers";
...
abstract class BaseSocket {
    ...
    public initialize() {
        this.ioSocket.on("connection", (socket) => {
          socket.on("enter-conversation", async (data) => await this.onConversationJoin(socket, data));
          socket.on("send-message", async(data) => await this.onMessageSend(socket, data));
